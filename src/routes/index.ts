...
router.get('/', (req, res) => {
  res.json({
    ...
    data: {
      message: '일등대리 API v1',
      version: '0.1.0',
      app: ['/auth', '/notices', '/contact', '/faqs', '/users', '/push-tokens', '/rides', '/mileage', '/withdrawals', '/cards', '/payments', '/referrals', '/inquiries', '/complaints', '/coupons', '/gifticon', '/receipts/cash', '/events', '/geocode', '/storage/presign-put', '/ai/chat'],
